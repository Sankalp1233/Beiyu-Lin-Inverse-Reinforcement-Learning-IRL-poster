...
while m<len(df['xpos_get_response']):
      ...
      if m != 1:
         ...
         first_10_elements_new_trajectories = new_trajectories[:10]
         first_10_elements_trajectories = trajectories[:10]
         first_10_elements_trajectories2 = trajectories2[:10]
         # print(first_10_elements_new_trajectories)
         n_actions = len(first_10_elements_new_trajectories)-1
         number_of_trajectories = 1
         length_of_trajectories = len(first_10_elements_new_trajectories)
         # length_of_trajectories = 10
         # print(new_trajectories)
         trajectories1 = np.array(first_10_elements_new_trajectories)
         ...
         # first_10_rows_new_trajectories2 = new_trajectories2[0][0:10,]
         # print(first_10_rows_new_trajectories2)
         ...
         new_counter = collections.Counter(first_10_elements_new_trajectories)
         ...
         # print(new_df_count)
         res = []
         for i in first_10_elements_trajectories:
             if i not in res: 
                res.append(i)
         res2 = []
         # denominator2 = len(trajectories2) - 1
         # denominator2 = len(new_trajectories2) - 1
         denominator2 = len(first_10_elements_trajectories2) - 1
         for i in first_10_elements_trajectories2: 
             if i not in res2: 
                res2.append(i)
         convert_res = []
         # print(res)
         ...
         # print(first_new_x_y_coordinates)
         ...
         # print(added_first_x_y_coordinates)
         ...
         # print(added_first_x_y_coordinates)
         # first_10_elements_added_first_x_y_coordinates = added_first_x_y_coordinates[:10]
         # first_10_elements_added_second_x_y_coordinates = added_second_x_y_coordinates[:10]
         # first_10_elements_added_third_new_x_y_coordinates = added_third_x_y_coordinates[:10]
         # first_10_elements_added_fourth_new_x_y_coordinates = added_fourth_x_y_coordinates[:10]
         ...
         for i in range(denominator2): 
             if first_10_elements_trajectories2[i] == first_10_elements_trajectories2[i+1]:
                matrix[first_10_elements_trajectories2[i]][first_10_elements_trajectories2[i+1]] += (1/n_actions)
             elif first_10_elements_trajectories2[i] != first_10_elements_trajectories2[i+1]:
                matrix[first_10_elements_trajectories2[i]][first_10_elements_trajectories2[i+1]] += (1/n_actions)
         ...
         def irl(structure, feature_matrix, n_actions, discount, transition_probability,
             ...
             print(reshaped_to_2d_reshape[0:2, :])
